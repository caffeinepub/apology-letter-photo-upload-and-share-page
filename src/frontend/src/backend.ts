...
import type { ApologyLetter as _ApologyLetter, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllApologyLetters(): Promise<Array<ApologyLetter>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllApologyLetters();
    ...
    async getApologyLetter(arg0: string): Promise<ApologyLetter> {
        if (this.processError) {
            try {
                const result = await this.actor.getApologyLetter(arg0);
                return from_candid_ApologyLetter_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async uploadApologyLetter(arg0: ExternalBlob, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadApologyLetter(await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ApologyLetter_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ApologyLetter): Promise<ApologyLetter> {
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ApologyLetter>): Promise<Array<ApologyLetter>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ApologyLetter_n9(_uploadFile, _downloadFile, x)));
}
